...
parser.add_argument('--name',  default='CIFAR10', help = 'Dataset')
parser.add_argument('--N1',    default=[50, 100, 200, 300, 400, 500],    help = 'Size of each sample')
parser.add_argument('--check', default=1,      help = '1 for test power; 0 for type-I error')
parser.add_argument('--rs',    default=[45, 1006, 1081, 1028, 1013, 107],      help = 'Random seed')
...
parser.add_argument('--R', default=[49, 99, 199, 299, 399, 499], help= 'Number of superdiagonals to consider')
...
parser.add_argument('--n_bandwidth', default=[(4, 4, 0, 4, 4, 0), (4, 4, 0, 4, 4, 0), (4, 4, 0, 4, 4, 0), (4, 4, 0, 4, 4, 0), (4, 4, 0, 4, 4, 0), (4, 4, 0, 4, 4, 0)], help='Number of bandwidths')
...
# 0.123±0.010 0.105±0.011 0.075±0.015                                             N50 seed45 bw220330 ep0
# 0.244±0.015 0.199±0.012 0.145±0.018                                             N100 seed1006 bw440440 ep0
# 0.566±0.020 0.483±0.022 0.528±0.047                                             N200 seed1081 bw440440 ep0
# 0.805±0.016 0.759±0.017 0.704±0.065                                             N300 seed1028 bw440440 ep0
# 0.924±0.012 0.887±0.014 0.825±0.037                                             N400 seed1013 bw440440 ep0
# 0.970±0.006 0.960±0.007 0.932±0.023                                             N500 seed107 bw440440 ep0
...
for i in range(len(args.N1)):
    ...
    for kk in range(args.n_exp): 
        ...
        # H_HSICAggCom, _, _ = IDT_HSICAgg(data_name, args.N1, kk+args.rs, args.check, args.n_test, args.alpha, args.R[i])
